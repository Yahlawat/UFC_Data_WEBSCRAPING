...
# Specify directory to save files using os for relative paths
save_path = os.path.join("Data")
os.makedirs(save_path, exist_ok=True)  # Create directory if it doesn't exist

# Save DataFrames as CSV files
event_links_df.to_csv(os.path.join(save_path, "event_links.csv"), index=False)
fights_df.to_csv(os.path.join(save_path, "fight_details.csv"), index=False)
